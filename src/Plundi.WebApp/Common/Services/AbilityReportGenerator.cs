...
namespace Plundi.WebApp.Common.Services;
...
public class AbilityReportGenerator
{
    ...
    public DamageReport GenerateDamageReport(IAbility ability, int characterLevel, AbilityRarity abilityRarity)
    {
        ...
        var calcTotalDamageRangeMethod =
            abilityDamageCalculatorType.GetMethod(nameof(IAbilityDamageCalculator<IAbility>.CalculateTotalDamageRange))!;
        var calcBaseDamageRangeMethod =
            abilityDamageCalculatorType.GetMethod(nameof(IAbilityDamageCalculator<IAbility>.CalculateBaseDamageRange))!;
        var calcSpecialDamageRangeMethod =
            abilityDamageCalculatorType.GetMethod(nameof(IAbilityDamageCalculator<IAbility>.CalculateSpecialDamageRange))!;
        var calcDotDamageRangeMethod =
            abilityDamageCalculatorType.GetMethod(nameof(IAbilityDamageCalculator<IAbility>.CalculateDotDamageRange))!;
        var calcBaseHitsMethod =
            abilityDamageCalculatorType.GetMethod(nameof(IAbilityDamageCalculator<IAbility>.CalculateBaseHits))!;
        var calcSpecialHitsMethod =
            abilityDamageCalculatorType.GetMethod(nameof(IAbilityDamageCalculator<IAbility>.CalculateSpecialHits))!;
        var calcDotHitsMethod =
            abilityDamageCalculatorType.GetMethod(nameof(IAbilityDamageCalculator<IAbility>.CalculateDotHits))!;
