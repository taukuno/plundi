...
public sealed partial class AbilitiesTimeToKillComparisonChart : IAsyncDisposable
{
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        _jsModule = await JsRuntime.InvokeAsync<IJSObjectReference>("import", "./js/charts/abilitiesTimeToKillComparisonChart.js");
