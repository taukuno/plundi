...
public sealed partial class AbilitiesDamageComparisonChart : IAsyncDisposable
{
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        _jsModule = await JsRuntime.InvokeAsync<IJSObjectReference>("import", "./js/charts/abilitiesDamageComparisonChart.js");
